...
import { Terminal, Code, Shield, Sword } from 'lucide-react';

const SummoningScroll = () => {
  const [displayText, setDisplayText] = useState('');
  const fullText = 'Forged in code. Tempered by challenge.';
        ...
        <div className="max-w-3xl mx-auto bg-[#0a0a0a] border border-gray-800 rounded-md p-6 shadow-lg">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="w-full md:w-2/5 mb-6 md:mb-0">
              <div className="font-mono text-gray-600 text-xs md:text-sm whitespace-pre animate-pulse">
                {asciiArt}
              </div>
              <div className="mt-4 flex justify-center space-x-4">
                <div className="flex flex-col items-center text-gray-500 text-xs">
                  ...
                  <span>RUNTIME</span>
                  <span className="text-gray-300">8+ YRS</span>
                </div>
                <div className="flex flex-col items-center text-gray-500 text-xs">
                  <Code className="w-4 h-4 mb-1" />
                  <span>COMMITS</span>
                  <span className="text-gray-300">5.2K+</span>
                </div>
                <div className="flex flex-col items-center text-gray-500 text-xs">
            ...
            <div className="w-full md:w-3/5 text-left">
              ...
              <h1 className="text-2xl md:text-3xl font-bold mb-3 text-gray-300 font-jetbrains">
                SHADOW_CASTER
              </h1>
              
              <div className="mb-3 flex items-center">
                <span className="bg-gray-800 px-2 py-1 text-xs text-gray-400 font-jetbrains rounded">
                  <span className="text-gray-500">class:</span> FULL_STACK_WARLOCK
                </span>
                <span className="ml-2 bg-gray-800 px-2 py-1 text-xs text-gray-400 font-jetbrains rounded">
                  <span className="text-gray-500">lvl:</span> 42
                </span>
              </div>
              
              <p className="font-jetbrains text-gray-400 mb-6 text-sm border-l-2 border-gray-700 pl-3 typewriter cursor-blink">
                {displayText}
              </p>
              ...
              <div className="flex space-x-2">
                <a 
                  href="#codex" 
                  className="bg-gray-800 hover:bg-gray-700 text-gray-300 text-xs px-4 py-2 rounded-sm transition-colors flex items-center"
                >
