...
const Footer = () => {
    const { github, linkedin, twitter, email } = info;
    const socialLinks = [
        ...
        { icon: <Mail className="w-4 h-4" />, href: email, label: "Email" },
    ];
        ...
        <footer className="py-8 bg-[#0a0a0a] border-t border-[#222]">
            <div className="container mx-auto px-4">
                <div className="flex flex-col items-center">
                    <div className="mb-6">
                        <div className="font-jetbrains text-xl text-gray-400 text-center w-full">
                            <span className="text-gray-600">&lt;</span>
                            <span className="text-gray-400">world_operator</span>
                            <span className="text-gray-600">&gt;</span>
                        </div>
                        <div className="font-jetbrains text-xs text-gray-600 mt-1">SYSTEM: {`${currentYear}.exe | all_rights_reserved`}</div>
                    </div>
